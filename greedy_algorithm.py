...
def greedy_algorithm(un_graph,int_theta,int_omega,D,M,K,OMEGA,KK,check_times,sigma,thres,t,nn,dtb_gnr,max_itr,type_rate):
    ...
    while k <= max_itr:
        ...
        for i in new_edge_list:
            ...
            if (rate_list39[j,type_rate]<new_rate):
                new_edge = temp_edge
                prev_rata = new_rate
                new_rate = rate_list39[j,type_rate]
            j+=1
