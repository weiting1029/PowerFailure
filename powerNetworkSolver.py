...
class PowerNetworkSolver(object):
    ...
    def Simulation(self, KK, check_times, sigma, thres, t, nn, dtb_gnr):
        ...
        return {'vcheck_omega': vcheck_omega, 'vcheck_theta': vcheck_theta, 'vcheck_any': vcheck_any,
                'mcheck_theta': mcheck_theta, 'mcheck_any': mcheck_any, 'totaltime': "{:2.2}sec".format(totaltime)}
